...
Группы в левом меню работают как аккордеон: разделы можно сворачивать и раскрывать, а состояние сохраняется в браузере.
...
8. При открытии документа через поиск родительские группы меню раскрываются автоматически
